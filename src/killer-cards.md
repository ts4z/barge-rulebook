...
*Abridged from [Tim Showalter's original version](https://psaux.com/poker/killer-cards.html) which includes more details nobody wants.*
...
have included a chart for [Hold'em](texas-holdem.md) as well as
[Omaha](omaha-high-only.md).  (Hopefully these charts didn't get mangled from
the translation from HTML, to Markdown, to LaTeX!)
