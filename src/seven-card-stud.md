...
Seven Card Stud, often just "Stud", was a dominant game for many decades.
...
by suit brings it in. The 2♣ is the lowest possible card followed by the
2♦, 2♥, 2♠, and so on.
...
betting at the small bet limit.  If a player shows an open pair a bet or raise
may optionally be a big bet (but see below). In this case a small bet can be
met by a big bet raise. A big bet may never be met with a small bet raise.
Action starts with the highest hand showing.
