...
example, if a player announces their hand as “Number #4” (i.e. the fourth best
possible hand), in California Lowball they would have 6542A, and in Kansas City
Lowball 76542. Of course, in the table below the hand cannot be single-suited
(a flush) to qualify in either Deuce-to-Seven or Ace-to-Six. Notice the
Ace-to-Six hands are obtained merely by subtracting one from each “digit” of
the corresponding Deuce-to-Seven hand.
...
“Sevens Rule” would apply). There are 35 eights, so a total of 56 hands that
are Eight-or-Better.  In Deuce-to-Seven, there are four sevens, 14 eights, and
34 nines, for a total of 52 hands that are nine-or-better. Number #53 is the
perfect ten, in case Bill Chen quizzes you. The same is true in Ace-to-Six;
