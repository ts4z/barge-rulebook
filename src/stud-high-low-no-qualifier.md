...
then by suit brings it in (as in [Razz](razz.md)). The K♠ is the highest
possible card followed by the K♥, K♦, K♣, and so on.
...
street will always be at the small bet limit. Action starts with the lowest
hand showing (as in [Razz](razz.md)).
...
The best high five-card hand and the best California low hand split the pot.
There is no qualifier for low.
