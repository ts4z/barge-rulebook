...
This is followed by a round of betting at the small bet limit.  Three turn
cards (one for each flop) are placed on the board, lined up vertically to the
right of the flops (forming a 3 × 4 grid). This is followed by a round of
betting at the big bet limit.  A fifth column of three additional community
cards are placed face up. At this point, the board will look like the
following:
...
removed. If all three river cards share the same rank, no boards are removed.
In this way, “tournament” Oklahoma differs from “cash game” Oklahoma,
where all three boards are removed and the dealer wins the pot.

For example, if Z1, Z2, and Z3 are the 3♥, 8♠, and 3♣ respectively, then
all of the cards on both row 1 and row 3 are removed. Board removal is followed
